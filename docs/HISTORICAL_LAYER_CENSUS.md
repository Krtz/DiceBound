...
| ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 | 1134 | `runtime/js/dicebound.js` | 8 | 14 | 13 | 25 | 4 | 109 | 4 | 2 | 5181 | onComplete×3, add×2, addCombatHistory×2, addLog×2, applyPoisonTick×2, beta04SyncHud×2, db317Board×2, defenseDamageReduction×2, filter×2, playElementAnimation×2, saveMeta×2, setCombatText×2, showToast×2 |
