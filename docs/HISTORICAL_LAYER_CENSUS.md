...
| 66 | 0 | `runtime/js/items/loot.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 142 | - |
| 67 | 0 | `runtime/js/items/rarities.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 80 | - |
| 68 | 0 | `runtime/js/native-http-host.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 39 | - |
| 69 | 0 | `runtime/js/pets/registry.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 47 | - |
| 70 | 0 | `runtime/js/powerups/borrowing.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 13 | - |
| 71 | 0 | `runtime/js/powerups/registry.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 2959 | - |
| 72 | 0 | `runtime/js/progression/achievements.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 268 | - |
| 73 | 0 | `runtime/js/progression/class-unlock-feedback.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 159 | - |
| 74 | 0 | `runtime/js/progression/talents.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 732 | - |
| 75 | 0 | `runtime/js/rng.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 25 | - |
| 76 | 0 | `runtime/js/run/completion.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 52 | - |
| 77 | 0 | `runtime/js/run/facade.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 99 | - |
| 78 | 0 | `runtime/js/run/lifecycle.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 63 | - |
| 79 | 0 | `runtime/js/run/player-initialization.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 122 | - |
...
| 84 | 0 | `runtime/js/ui/merchant.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 67 | - |
| 85 | 0 | `runtime/js/ui/options.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 118 | - |
| 86 | 0 | `runtime/js/ui/pet-chooser.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 186 | - |
| 87 | 0 | `runtime/js/ui/prestige-moon.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 116 | - |
| 88 | 0 | `runtime/js/ui/talent-tree.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 240 | - |
| 89 | 0 | `runtime/js/version.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 21 | - |
