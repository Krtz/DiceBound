...
| ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 | 1764 | `runtime/js/dicebound.js` | 12 | 40 | 34 | 32 | 12 | 114 | 6 | 2 | 6073 | damageEnemy×5, effectiveDodgeChance×3, getHeirloomSlots×3, onComplete×3, add×2, addCombatHistory×2, addLog×2, applyPoisonTick×2, beta04SyncHud×2, db317Board×2, defenseDamageReduction×2, filter×2, generateMythicalAmulet×2, generateMythicalBoots×2, generateMythicalHat×2, generateMythicalOffhand×2, generateMythicalPants×2, generateMythicalRing×2, generateMythicalWeapon×2, grantXp×2, handlePlayerDeath×2, loseGame×2, playElementAnimation×2, rollDice×2, rollGearRarity×2, saveMeta×2, setCombatText×2, showEnd×2, showToast×2, unboundPreciousGearV16×2, useCamp×2, v13NormalizeMeta×2, v15ParseSeedCode×2, weightedUpgrade×2 |
...
| 37 | 3 | `runtime/js/items/consumables.js` | 0 | 0 | 0 | 0 | 0 | 1 | 0 | 0 | 161 | - |
| 38 | 2 | `runtime/js/items/generation.js` | 0 | 0 | 0 | 0 | 0 | 0 | 1 | 0 | 168 | - |
| 39 | 2 | `runtime/js/ui/camp-shell.js` | 0 | 0 | 0 | 0 | 0 | 0 | 1 | 0 | 83 | - |
| 40 | 0 | `runtime/js/assets.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 183 | - |
| 41 | 0 | `runtime/js/board/generation.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 221 | - |
| 42 | 0 | `runtime/js/board/movement.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 74 | - |
...
| 47 | 0 | `runtime/js/classes/registry.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 1310 | - |
| 48 | 0 | `runtime/js/combat/element-content.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 34 | - |
| 49 | 0 | `runtime/js/combat/enemies.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 291 | - |
| 50 | 0 | `runtime/js/combat/enemy-policy.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 44 | - |
| 51 | 0 | `runtime/js/combat/enemy-scaling-resolution.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 83 | - |
| 52 | 0 | `runtime/js/combat/facade.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 80 | - |
| 53 | 0 | `runtime/js/combat/guardians.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 55 | - |
| 54 | 0 | `runtime/js/combat/presentation.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 338 | - |
| 55 | 0 | `runtime/js/combat/strike-policy.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 30 | - |
| 56 | 0 | `runtime/js/combat/targeting.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 47 | - |
| 57 | 0 | `runtime/js/combat/view-facade.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 88 | - |
| 58 | 0 | `runtime/js/core/facade.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 66 | - |
| 59 | 0 | `runtime/js/core/memory-diagnostics.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 339 | - |
| 60 | 0 | `runtime/js/core/run-checkpoint.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 120 | - |
| 61 | 0 | `runtime/js/core/runtime-services.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 62 | - |
| 62 | 0 | `runtime/js/events/facade.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 39 | - |
| 63 | 0 | `runtime/js/events/merchant-facade.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 85 | - |
| 64 | 0 | `runtime/js/events/merchant-transaction.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 135 | - |
| 65 | 0 | `runtime/js/items/artifacts.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 44 | - |
| 66 | 0 | `runtime/js/items/facade.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 54 | - |
| 67 | 0 | `runtime/js/items/loot.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 142 | - |
| 68 | 0 | `runtime/js/items/rarities.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 80 | - |
| 69 | 0 | `runtime/js/native-http-host.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 39 | - |
| 70 | 0 | `runtime/js/pets/registry.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 47 | - |
| 71 | 0 | `runtime/js/powerups/borrowing.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 13 | - |
| 72 | 0 | `runtime/js/powerups/registry.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 2959 | - |
| 73 | 0 | `runtime/js/progression/achievements.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 268 | - |
| 74 | 0 | `runtime/js/progression/class-unlock-feedback.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 159 | - |
| 75 | 0 | `runtime/js/progression/talents.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 732 | - |
| 76 | 0 | `runtime/js/rng.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 25 | - |
| 77 | 0 | `runtime/js/run/completion.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 52 | - |
| 78 | 0 | `runtime/js/run/dice.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 63 | - |
| 79 | 0 | `runtime/js/run/facade.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 99 | - |
| 80 | 0 | `runtime/js/run/lifecycle.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 63 | - |
| 81 | 0 | `runtime/js/run/player-initialization.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 122 | - |
| 82 | 0 | `runtime/js/ui/achievements.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 173 | - |
| 83 | 0 | `runtime/js/ui/class-chooser.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 152 | - |
| 84 | 0 | `runtime/js/ui/equipment-heirlooms.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 168 | - |
| 85 | 0 | `runtime/js/ui/info-guide.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 168 | - |
| 86 | 0 | `runtime/js/ui/merchant.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 67 | - |
| 87 | 0 | `runtime/js/ui/options.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 118 | - |
| 88 | 0 | `runtime/js/ui/pet-chooser.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 186 | - |
| 89 | 0 | `runtime/js/ui/prestige-moon.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 116 | - |
| 90 | 0 | `runtime/js/ui/talent-tree.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 240 | - |
| 91 | 0 | `runtime/js/version.js` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 21 | - |
