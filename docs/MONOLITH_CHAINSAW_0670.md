...
- Monolith after source cleanup: **6,956 lines / 597,139 UTF-8 bytes**.
- Physical reduction: **221 lines / 52,271 bytes**.
...
- Dead supporting literal declarations removed after their no-op writers disappeared: **3**.
