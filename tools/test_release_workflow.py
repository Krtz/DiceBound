...
for marker in [
    ...
    "DiceBound manifest App token preflight: installation includes Krtz/DiceBound; requested permission contents=write.",
    ...
    "Write-ManifestPutFailureDiagnostic",
    "GitHub API failure diagnostic:",
