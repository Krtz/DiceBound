...
assert.match(monolith,/const dbRunOpenStartBase=openStartScreen;openStartScreen=function\(\.\.\.args\)\{dbRunClearCheckpoint\(\);/,"between-run start boundary must clear the active-run checkpoint");
