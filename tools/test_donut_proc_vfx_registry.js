...
assert.equal(effect.image, "assets/combat/effects/donut-proc-rain-spritesheet.png");
...
console.log("Donut proc VFX registry: canonical battlefield overlay asset and timing pass");
