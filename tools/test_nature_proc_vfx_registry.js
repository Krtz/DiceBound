...
assert.deepEqual(JSON.parse(JSON.stringify(effect.frames)),[1,2,3,4,5,6,7,8].map(frame=>`assets/combat/effects/nature/nature-poison-vines-${String(frame).padStart(2,"0")}.png`));
