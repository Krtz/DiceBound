...
async function main(){
 ...
 try{
   ...
   if(tooltipProbe.hidden||!tooltipProbe.tip.startsWith('Hawkeye Charm\nCOMMON · AMULET\n')||!tooltipProbe.text.includes('Hawkeye Charm')||!tooltipProbe.text.includes('Crit')||!tooltipProbe.text.includes('Dodge')||tooltipProbe.text.includes('No bonuses')||tooltipProbe.whiteSpace!=="pre-line")throw new Error(`Character gear root tooltip lost semantic identity/intrinsic stats: ${JSON.stringify(tooltipProbe)}`);
