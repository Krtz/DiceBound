...
async function main(){
  ...
  try{
    ...
    if(await page.evaluate("!!document.querySelector('#infoOverlay [data-info-tab=\"stats\"]')"))throw new Error("file:// Info retained duplicate Career Stats tab");
    await pointerClick(page,"#infoOverlay [data-info-done]");
