...
assert.deepEqual({...defaults.echoCrucible},{learnedEffectIds:[],selectedEffectId:null,moonMetal:0},"fresh careers must start with an empty Echo Crucible");
...
assert.deepEqual({...meta.echoCrucible},{learnedEffectIds:[],selectedEffectId:null,moonMetal:0},"legacy saves must normalize missing Echo Crucible state");
