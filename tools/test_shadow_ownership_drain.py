...
assert mono.count('async function rollD20Chaos(action){') == 0, 'retired rollD20Chaos compatibility adapter returned'
...
assert 'dbCombat.chaos(' in mono, 'D20 callers no longer route through the Combat facade'
