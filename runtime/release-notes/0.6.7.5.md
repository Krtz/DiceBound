...
- Moves the backflip / land-back / slide-home lifecycle out of `dicebound.js` and into canonical Combat Presentation, with retrigger-safe cleanup.
- Prevents pure successful-Dodge turns from also playing hit SFX or recording hit damage.
