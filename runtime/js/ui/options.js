...
(function(root){
  ...
  function sync(){
    ...
    const slider=find('optionsVolumeSlider'),volumeValue=find('optionsVolumeValue'),packSelect=find('optionsSoundPackSelect'),floatingButton=find('optionsFloatingNumbersBtn'),fastCard=find('optionsFastEventsCard'),fastButton=find('optionsFastEventsBtn');
    ...
    return Object.freeze({owner:OWNER,muted:state.muted,volume:state.masterVolume,soundPack:state.soundPack,floatingCombatNumbers:state.floatingCombatNumbers,fastWheelSlots:state.fastWheelSlots,fastWheelSlotsUnlocked:state.fastWheelSlotsUnlocked,nativeSaveSupported:supported});
  }
