...
(function(root){
  ...
  function campTemplate(){
    return `<div class="camp-topline"><span id="campLegacyLine"></span><span id="campPetLine"></span></div>
      ...
      <div class="camp-popup-layer" id="campPopupLayer">
        <div class="camp-panel" id="campClassPanel"><div id="campClassHost"><div class="class-grid" id="classGrid"></div></div></div>
  ...
  function progressionObjectMarkup(id){
    ...
    if(id==='campMoonBtn')return '<div class="camp-icon">🌙</div><div class="camp-sub">Prestige &amp; reset</div>';
    return '';
  }
