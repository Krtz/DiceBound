(() => {
  ...
  const DEMON_FLAME_MODE_BONUSES = Object.freeze({ normal: 0, nightmare: 0.30, hell: 0.60 });
  ...
  function standardDemonFlameChance(board, mode = "normal") {
    return Number(Math.min(0.90, boardNumber(board) * 0.05 + DEMON_FLAME_MODE_BONUSES[modeId(mode)]).toFixed(2));
  }
