(() => {
  ...
  const EQUIPMENT_DATA={slots:[
    ...
    {id:"decennial-jubilee-balloons",displayName:"Decennial Jubilee Balloons",slot:"amulet",family:"balloon",material:"festival-rubber",weight:"light",tags:["festival","holiday","fortune","epic-visual"],rarityEligibility:["epic","legendary"],rollWeight:1,art:{image:"assets/equipment/amulet/decennial-jubilee-balloons.png",alt:"Extravagant Decennial Jubilee Balloons"},visual:{rig:"humanoid-v1",anchor:"neck",layer:70}},
    {id:"ashcore-pyrestaff",displayName:"Ashcore Pyrestaff",slot:"weapon",family:"staff",material:"emberwood",weight:"medium",tags:["arcane","caster","ember","epic-visual"],rarityEligibility:["epic","legendary"],rollWeight:1,classRollModifiers:{sorcerer:1.6,cleric:1.35,alchemist:1.3,summoner:1.25},art:{image:"assets/equipment/weapon/ashcore-pyrestaff.png",alt:"Extravagant Ashcore Pyrestaff"},visual:{rig:"humanoid-v1",anchor:"weapon-hand",layer:50}},
    {id:"candlecrown-gateau",displayName:"Candlecrown Gateau",slot:"offhand",family:"gateau",material:"cake",weight:"light",tags:["food","holiday","sustain","epic-visual"],rarityEligibility:["epic","legendary"],rollWeight:1,art:{image:"assets/equipment/offhand/candlecrown-gateau.png",alt:"Extravagant Candlecrown Gateau"},visual:{rig:"humanoid-v1",anchor:"offhand",layer:40}}
  ]};
